    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <br><br><br>
                <h1>
                    <center>DUMMY DATA LAB</center>
                    <hr>
                </h1>
                <center>
                    <p><b>DUMMY DATA LAB</b> merupakan aplikasi yang dibuat<br>
                        untuk mendapatkan data dummy yang bisa digunakan <br>
                        dalam proses belajar seperti latihan CRUD sederhana</p>
                    <p>Data dummy didapatkan dari <a href="https://fakerapi.it/">FAKER API</a> </p>
                </center>
            </div>
        </div>
    </div>
